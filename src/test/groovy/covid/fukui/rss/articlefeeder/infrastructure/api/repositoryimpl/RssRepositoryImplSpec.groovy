...
class RssRepositoryImplSpec extends Specification {
    ...
    final "getArticlesメソッド"() {
        ...
        final expectedResults = [
                new Article(
                        new OriginalTitle("新型コロナウイルスのワクチン接種　ファイザー、モデルナ、アストラゼネカ…対象年齢、副反応など違いは？"),
                        Link.from("https://www.fukuishimbun.co.jp/articles/-/1336511"),
                        new DateTime(LocalDateTime.of(2021, 06, 27, 11, 00, 00))),
                new Article(
                        new OriginalTitle("企業向けの職場接種と大学接種　対象や申請条件、使用するワクチンは？ 新型コロナ職域接種"),
                        Link.from("https://www.fukuishimbun.co.jp/articles/-/1336523"),
